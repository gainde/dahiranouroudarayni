...
public class CotisationController implements Initializable{
    ...
    private void HandleButtonAjouterLoyer(){
    	btnAjouterLoyer.setOnMouseReleased(new EventHandler<Event>() {
			...
			public void handle(Event event) {
				valide = validateurManager.valider(valideurLoyer);
				if(valide){
    ...
    private void HandleButtonAjouterKST(){
    	btnAjouterKST.setOnMouseReleased(new EventHandler<Event>() {
			...
			@Override
			public void handle(Event event) {
				valide =validateurManager.valider(valideurKST);
				if(valide){
    ...
    private void HandleButtonAjouterEvenement(){
    	btnAjouterEvenement.setOnMouseReleased(new EventHandler<Event>() {
			...
			@Override
			public void handle(Event event) {
				valide = validateurManager.valider(valideurEvent);
				if(valide){
	...
	private void initialiserValidation(){
		valideurLoyer = validateurManager.add(new ValidateurMontant(txtMontantLoyer,
				textErrLoyer, true, ValidationErreur.MONTANT_ERR));
		
		valideurEvent = validateurManager.add(new ValidateurMontant(txtMontantEvenement,
				textErrEvenement, true, ValidationErreur.MONTANT_ERR));
